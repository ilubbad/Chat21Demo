...
// Prevent form the reflection api.
    ...
    public void registerFirebaseReceiver(Context context) {
        ...
        mTokenReceiver = new TokenBroadcastReceiver() {
            ...
            public void onNewToken(String token) {
                Log.i(DebugConstants.DEBUG_LOGIN, "onNewToken:" + token);
    ...
    public void createAuthListener(final OnAuthStateChangeListener onAuthStateChangeListener) {
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    // User is signed in
                    Log.i(DebugConstants.DEBUG_LOGIN, "onAuthStateChanged:signed_in:" + user.getUid());
    ...
    public void signInWithUid(final Activity loginActivity, final String appId,
        ...
        new GetCustomTokenTask(new OnCustomAuthTokenCallback() {
            ...
            public void onCustomAuthRetrievedSuccess(String token) {
                Log.i(DebugConstants.DEBUG_LOGIN, "signInWithUid.onCustomAuthRetrievedSuccess : authToken == " + token);
    ...
    private void createContactNode(String appId, String userId) {
        Log.d(DebugConstants.DEBUG_LOGIN, "createContactNode: userId == " + userId);
    ...
    public void updateNodeContacts(String appId, String userId, String email, String name, String surname) {
        Log.d(DebugConstants.DEBUG_LOGIN, "updateNodeContacts: userId == " + userId + ", email == "
                ...
                .addOnCompleteListener(loginActivity, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            Log.d(DebugConstants.DEBUG_LOGIN, "calling  onChatLoginCallback.onChatLoginSuccess() iChatUser :  " + iChatUser);
    ...
    public void signInWithToken(final Activity loginActivity, String token,
        ...
        getFirebaseAuth().signInWithCustomToken(token).addOnCompleteListener(loginActivity, new OnCompleteListener<AuthResult>() {
            ...
            public void onFailure(@NonNull Exception e) {
                Log.e(DebugConstants.DEBUG_LOGIN, "signInWithCustomToken.onFailure", e);
            }
        });
    }
...
//                };
                ...
                if (logoutException == null) {
                    ...
                    Log.e(DebugConstants.DEBUG_LOGIN, "cannot sign outfrom firebase. " + logoutException.getMessage());
                    onChatLogoutCallback.onChatLogoutError(logoutException);
                }
    ...
    private void setCustomToken(String token) {
        Log.d(DebugConstants.DEBUG_LOGIN, "setCustomToken: token == " + token);
        ...
        Log.d(DebugConstants.DEBUG_LOGIN, "status == " + status);
    }
        ...
        if (StringUtils.isValid(email)) {
            ...
            user.updateEmail(email).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    ...
                    if (task.isSuccessful()) {
                        Log.i(DebugConstants.DEBUG_LOGIN, "User email address (" + email + ") " +
                        ...
                        Log.e(DebugConstants.DEBUG_LOGIN, errorMessage);
    ...
    private void updateUserProfile(final String displayName, Uri userPhotoUri) {
        Log.d(DebugConstants.DEBUG_LOGIN, "updateUserProfile: displayName == " + displayName
        ...
        if (StringUtils.isValid(displayName)) {
            ...
            user.updateProfile(profileUpdates).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    ...
                    if (task.isSuccessful()) {
                        Log.i(DebugConstants.DEBUG_LOGIN, "User profile (" + displayName + ")" +
                                " updated with success for user with uid: " + user.getUid());
    ...
    public void setEmail(String email) {
        Log.d(DebugConstants.DEBUG_LOGIN, "setEmail: email == " + email);
    ...
    public void setFullName(String fullName) {
        Log.d(DebugConstants.DEBUG_LOGIN, "setFullName: fullName == " + fullName);

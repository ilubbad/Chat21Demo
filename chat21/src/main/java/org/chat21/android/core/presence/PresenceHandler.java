...
public class PresenceHandler {
    ...
    public void upsertPresenceListener(PresenceListener presenceListener) {
        if (presenceListeners.contains(presenceListener)) {
            ...
            Log.i(DebugConstants.DEBUG_USER_PRESENCE, "PresenceHandler.upsertPresenceListener: " +
    ...
    public ValueEventListener connect() {
        ...
        valueEventListener = userPresenceRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                Log.i(DebugConstants.DEBUG_USER_PRESENCE, "PresenceHandler.connect.onDataChange:" +
                ...
                if (dataSnapshot.getValue() != null) {
                    ...
                    try {
                        ...
                        Log.w(DebugConstants.DEBUG_USER_PRESENCE, "PresenceHandler.connect.onDataChange:" +
            ...
            public void onCancelled(DatabaseError databaseError) {
                Log.w(DebugConstants.DEBUG_USER_PRESENCE, "PresenceHandler.connect.onCancelled: " +
